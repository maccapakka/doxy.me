...
export const HelloWorld: Story = {
  render: () => (
    <Container
      gap={5}
      gridTemplateAreas={desktopLayout}
      maxWidth="1000px"
      padding={5}
    >
      <Aside alignItems="flex-start" gridArea="aside">
        <Card>
          <Stack>
            <Text color="secondary" weight="bold">
              Your Provider
            </Text>
            <Box background="neutral-subtle" paddingBlock={3} paddingInline={3}>
              <Box
                alignItems="center"
                gap={3}
                gridTemplateAreas="'avatar text'"
              >
                <Box gridArea="avatar" padding={0}>
                  <Avatar
                    initials="SM"
                    size={11}
                ...
                <Stack gap={0} gridArea="text">
                  <Text color="secondary" weight="bold">
                    Stevie McCann
                  </Text>
                  <Text color="neutral-bold" variant="body-2">
                    Online
                  </Text>
                </Stack>
              </Box>
          ...
          <Stack gap={2}>
            ...
            <Stack gap={3}>
              ...
              <Box background="primary-subtle" padding={3}>
                ...
                >
                  <Icon color="primary-bold" size={6} svg={OneIcon} />
                  <Text>
              ...
              <Box background="primary-subtle" padding={3}>
                <Box
                  ...
                  gridTemplateAreas="'icon text'"
                >
                  <Icon color="primary-bold" size={6} svg={TwoIcon} />
                  <Stack gap={1}>
                    <Text color="secondary" weight="bold">
      ...
      <Section alignItems="flex-start" gridArea="camera">
        <Stack>
          <Box
            alignItems="flex-end"
            background="black"
            ...
            width="100%"
          >
            <Text color="white" elevated weight="bold">
              You
            </Text>
          </Box>
